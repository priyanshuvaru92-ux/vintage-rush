...
export default function AboutPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section style={{ paddingTop: "120px", paddingBottom: "80px", background: "#080808", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "30%", left: "50%", transform: "translateX(-50%)", width: "600px", height: "600px", borderRadius: "50%", background: "rgba(201,169,110,0.03)", filter: "blur(100px)", pointerEvents: "none" }} />
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", position: "relative" }}>
          ...
          >
            ...
            <h1 style={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: "clamp(52px, 7vw, 96px)", fontWeight: 300, lineHeight: 1.0, color: "#f5f0eb", marginBottom: "32px" }}>
              Born in Surat,<br />
              <span style={{ fontStyle: "italic", color: "#e8dfd0" }}>Built for the Streets</span>
            </h1>
            <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "18px", color: "rgba(245,240,235,0.5)", lineHeight: "1.9", maxWidth: "560px" }}>
      ...
      <section style={{ padding: "100px 0", background: "#0c0c0c" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }} className="about-grid">
            ...
            >
              <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "15px", color: "rgba(245,240,235,0.55)", lineHeight: "2", marginBottom: "24px" }}>
              ...
              <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "15px", color: "rgba(245,240,235,0.55)", lineHeight: "2", marginBottom: "40px" }}>
      ...
      <section style={{ padding: "100px 0", background: "#080808" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            <h2 style={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 400, color: "#f5f0eb" }}>
              Our Values
            </h2>
          </motion.div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "rgba(255,255,255,0.04)" }} className="values-grid">
            {[
              ...
              <motion.div
                ...
                style={{ padding: "48px 40px", background: "#080808" }}
              >
                <span style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: "48px", fontWeight: 300, color: "rgba(201,169,110,0.15)", display: "block", marginBottom: "16px", lineHeight: 1 }}>
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h3 style={{ fontFamily: '"Cormorant Garamond", Georgia, serif', fontSize: "28px", fontWeight: 500, color: "#f5f0eb", marginBottom: "12px" }}>
                  {v.title}
                </h3>
                <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "14px", color: "rgba(245,240,235,0.4)", lineHeight: "1.8" }}>
                  {v.body}
                </p>
              </motion.div>
            ))}
      ...
      {/* Contact CTA */}
      <section style={{ padding: "80px 0 100px", background: "#111111" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", padding: "0 24px", textAlign: "center" }}>
          <h2 style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 400, color: "#f5f0eb", marginBottom: "16px" }}>
            Get in Touch
          </h2>
          <p style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "14px", color: "rgba(245,240,235,0.45)", marginBottom: "40px", lineHeight: "1.8" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", alignItems: "center" }}>
            {[
              ...
              <div key={text} style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                {href ? (
                  <a href={href} style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "14px", color: "rgba(245,240,235,0.6)", textDecoration: "none" }}>
                    {text}
                  </a>
                ) : (
                  <span style={{ fontFamily: '"DM Sans", sans-serif', fontSize: "14px", color: "rgba(245,240,235,0.6)" }}>{text}</span>
                )}
              </div>
            ))}
          </div>
